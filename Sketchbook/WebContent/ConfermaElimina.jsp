...
<head>
    ...
    <title>Elimina Prodotto Confermata</title>
...
<body>
   ...
   <h1 class="align-center"><i class="ion-android-done"></i> Il prodotto è stato cancellato correttamente. <i class="ion-android-done"></i></h1>
   <hr class="offset-xl">
   <h3 class="h4 align-center"><a href="ModificaCatalogo.jsp">Torna Indietro</a></h3>
