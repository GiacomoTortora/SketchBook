    ...
    <div class="container checkout">
        ...
        <div class="row">
            <div class="col-md-7">
                  ...
                  <div class="row group">
                    <div class="col-sm-4"><h2 class="h4">Scegli Paese</h2></div>
                    <div class="col-sm-8">
                  ...
                  <div class="row group">
                    ...
                    <div class="col-sm-8">
                      <div class="group-select justify" tabindex='1'>
                          <input class="form-control select" id="payment" name="payment" value="PayPal" required/>

                          <ul class="dropdown">
                            <li data-value="Cash on Delivery">Contrassegno</li>
                            <li data-value="Credit Card">Carta di Credito / Debito</li>
                            <li data-value="Paypall">PayPal</li>
                          </ul>
