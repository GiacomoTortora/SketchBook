...
Collection<ProductBean> products = new ProductDAO().doRetrieveByName(term);

if(term==null || products==null) response.sendRedirect("general-error.jsp");
%>
...
<body>
    ...
    <h1 class="align-center">Risultati per '<%=term%>'</h1>
