        ...
        <div class="col-sm-12">
          ...
          <div class="products">
            <div class="row">
              ...
              <div class="col-sm-6 col-md-4 product">
                <div class="body">
                  <a href="../store/"><img src="assets/img/products/surface-pro.jpg" alt="Surface Pro"/></a>
              ...
              <div class="col-sm-6 col-md-4 product">
                <div class="body">
                  <a href="../store/"><img src="assets/img/products/hp-spectre-x360.jpg" alt="HP Spectre x360"/></a>
              ...
              <div class="col-sm-6 col-md-4 product visible-sm">
                <div class="body">
                  <a href="../store/"><img src="assets/img/products/dell-inspiron-2in1.jpg" alt="Dell Inspiron 7000 2-in-1s"/></a>
              ...
              <div class="col-sm-6 col-md-4 product">
                <div class="body">
                  <a href="../store/"><img src="assets/img/products/apple-imac-27-retina.jpg" alt="Apple iMac 27 Retina"/></a>
              ...
              <div class="col-sm-6 col-md-4 product">
                <div class="body">
                  <a href="../store/"><img src="assets/img/products/microsoft-surface-studio.jpg" alt="Microsoft Surface Studio"/></a>
              ...
              <div class="col-sm-6 col-md-4 product">
                <div class="body">
                  <a href="../store/"><img src="assets/img/products/dell-inspiron-23.jpg" alt="Dell Inspion 23"/></a>
              ...
              <div class="col-sm-6 col-md-4 product visible-sm">
                <div class="body">
                  <a href="../store/"><img src="assets/img/products/lenovo-ideacenter.jpg" alt="Lenovo IdeaCenter"/></a>
