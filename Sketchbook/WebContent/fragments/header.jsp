        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                  <h2 class="modal-title text-center">Prodotto Aggiunto al Carrello</h2>
                  <br>
                  <div class="social-login">
                      <div class="or"></div><br>
                      <div class="row">
                      <div class="col-sm-4 col-md-6">
                      <a href="" class="btn btn-primary" onSubmit="window.location.reload()">Continua</a>
                      </div>
                      <div class="col-sm-4 col-md-6">
                      <a href="Cart.jsp" class="btn btn-warning">Vai al Carrello</a>
                      </div>
                      </div>
                  </div>
                  <br><br>
